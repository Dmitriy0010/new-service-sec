...
public class CacheConfig {
    ...
    public CacheManager caffeineCacheManager() {
        // Если Caffeine на classpath — можно настроить CaffeineCacheManager.
        // Жёстко импортировать класс не нужно здесь: Spring сам подставит подходящий бин,
        // но если хотите полную реализацию — добавьте зависимость и используйте CaffeineCacheManager.
